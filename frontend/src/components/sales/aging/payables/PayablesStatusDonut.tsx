...
import type { PayablesStatusSplit } from '../../../../lib/api'
import { fmtAmount } from '../../../../lib/fmt'
import { agingStatusDonutSize } from '../shared/agingChartSizes'

const SEGMENTS = [
  { key: 'before_due' as const, label: 'Not yet due', color: '#16A34A' },
  { key: 'overdue' as const, label: 'Overdue', color: '#F59E0B' },
]

export default function PayablesStatusDonut({
  split,
  compact = false,
}: {
  split: PayablesStatusSplit
  compact?: boolean
}) {
