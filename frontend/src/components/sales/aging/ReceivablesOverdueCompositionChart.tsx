...
import type { ReceivablesCompositionSegment } from '../../../lib/api'
...
export default function ReceivablesOverdueCompositionChart({
  segments,
}: {
  segments: ReceivablesCompositionSegment[]
}) {
